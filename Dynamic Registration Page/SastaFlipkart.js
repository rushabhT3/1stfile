function onSignUp(event) {
    ...
    if (price && product && category) {
        axios.post(`https://crudcrud.com/api/7d7ac4af2b804c0cba235fd207c256d9/SastaFlipkart`, myObj)
            .then((response) => {
...
document.addEventListener('DOMContentLoaded', () => {
    axios.get(`https://crudcrud.com/api/7d7ac4af2b804c0cba235fd207c256d9/SastaFlipkart`)
        .then((resolve) => {
...
function onScreenFunction(myObj) {
    ...
    delBtn.onclick = () => {
        axios.delete(`https://crudcrud.com/api/7d7ac4af2b804c0cba235fd207c256d9/SastaFlipkart/${myObj._id}`)
            .then(() => {
                if (myObj.category == 'Electronics') {
